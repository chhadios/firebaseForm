...
const Seller =(props)=>{
    ...
    return(
        ...
        <div className="form-container-seller">
            <form >
                <div className="file-seller">
                <label className="form-label-seller">businessLogo</label>
                <input className="form-input-seller" type="file" onChange={handleUploadChange}></input>
                ...
                <label className="form-label-seller">businessName</label>
                <input onChange={e => setbusinessName(e.target.value)} className="form-input-seller" type="text"></input>
                
                <label className="form-label-seller">category</label>
                <input onChange={e => setcategory(e.target.value)} className="form-input-seller" type="text"></input>
                
                <label className="form-label-seller">description</label>
                <input onChange={e => setdescription(e.target.value)} className="form-input" type="text"></input>
                
                <label className="form-label-seller">name</label>
                <input onChange={e => setname(e.target.value)} className="form-input-seller" type="text"></input>

                <label className="form-label-seller">phone</label>
                <input onChange={e => setphone(e.target.value)} className="form-input-seller" type="text"></input>
                

                <label className="form-label-seller">tagline</label>
                <input onChange={e => settagline(e.target.value)} className="form-input-seller" type="text"></input>

                <div className="file-seller">
                <label className="form-label-seller">sellerPhoto</label>
                <input onChange={handlephotoUploadChange} className="form-input-seller" type="file"></input>
                ...
                <div className="file-seller">
                <label className="form-label-seller">review</label>
                <input className="form-input-seller"  type="file" multiple  onChange={onFileChange} ></input>
                ...
                <button className="btn-submit-seller" onClick={(e) => handledefault(e)}> submit</button>
                {loader ?
                <Box sx={{ display: 'flex' }}>
                    <CircularProgress />
                </Box>
